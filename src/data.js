export const siteData = {
  ...
  hero: {
    title: "Transformamos espacios exteriores en lugares únicos.",
    subtitle:
      "Especialistas en instalación de zacate, paisajismo, jardinería, mantenimiento y control de malezas en toda Costa Rica.",
    ctaWhatsApp: "Solicitar una asesoría",
  ...
  about: {
    ...
    text1:
      "R&T Diseño Verde nace en Carrillos Alto de Poás con un objetivo claro: ayudar a nuestros clientes a tener jardines bonitos, frescos y sanos, sin complicarse con el mantenimiento.",
    text2:
      "Trabajamos de forma directa, sin intermediarios, y conocemos muy bien el clima y los diferentes tipos de suelo del país. Ofrecemos cobertura nacional para llevar el mejor zacate a su hogar, empresa o propiedad recreativa.",
  ...
  services: [
    {
      ...
      items: [
        "Preparación técnica de suelo",
        "Suministro de tierra vegetal seleccionada",
        "Garantía de nivelación funcional",
      ],
