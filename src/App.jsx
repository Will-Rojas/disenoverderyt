...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${scrolled ? "nav-scrolled" : ""} ${menuOpen ? "nav-open" : ""}`}
    >
      <div className="container navbar-container">
        ...
        <div className={`nav-links-wrapper ${menuOpen ? "active" : ""}`}>
          <div className="nav-links">
            ...
            <a href="#tipos-zacate" onClick={() => setMenuOpen(false)}>
              Variedades
            </a>
            <a href="#cobertura" onClick={() => setMenuOpen(false)}>
              Cobertura
            </a>
...
const Services = () => {
  const prepAndDesignServices = siteData.services.filter(
    (s) => s.category === "prep-design",
  );
  const maintenanceServices = siteData.services.filter(
    ...
    <section id="servicios" style={{ backgroundColor: "#f9fbf9" }}>
      <div className="container">
        ...
        >
          ...
          <p
            style={{ maxWidth: "700px", margin: "0 auto", fontSize: "1.2rem" }}
          >
            Mucho más que solo grama. Ofrecemos soluciones integrales para su
            jardín.
          </p>
        </div>
        ...
        <div style={{ marginBottom: "80px" }}>
          ...
          >
            {prepAndDesignServices.map((service, idx) => (
              <div
                key={service.id}
                className={`service-card reveal delay-${(idx % 3) + 1}`}
              >
                <div className="icon-box">
                  <ServiceIcon name={service.icon} />
                </div>
                <h3 style={{ marginBottom: "15px", fontSize: "1.6rem" }}>
                  {service.title}
                </h3>
                <p
                  style={{
        ...
        <div>
          ...
          >
            {maintenanceServices.map((service, idx) => (
              <div
                key={service.id}
                className={`service-card reveal delay-${(idx % 2) + 1}`}
              >
                <div className="icon-box">
                  <ServiceIcon name={service.icon} />
                </div>
...
const ZacateCatalog = () => (
  <section id="tipos-zacate">
    <div className="container">
      ...
      >
        <h2 style={{ fontSize: "3.5rem", marginBottom: "15px" }}>
          Nuestras Variedades
        </h2>
        <p style={{ maxWidth: "600px", margin: "0 auto" }}>
          Seleccionamos las mejores variedades adaptadas al clima tropical de
          Costa Rica.
        </p>
      </div>
      <div
      ...
      >
        {siteData.zacateTypes.map((type, i) => (
          <div
            key={type.id}
            className={`zacate-card reveal delay-${(i % 4) + 1}`}
          >
      ...
      >
        * Imágenes con fines ilustrativos. El tono y textura natural pueden
    ...
    <div className="container">
      ...
      >
        <div className="reveal">
          <h2
            style={{ color: "white", fontSize: "3.5rem", marginBottom: "25px" }}
          >
            {siteData.coverage}
          </h2>
          <p
          ...
          >
            No importa dónde se encuentre su proyecto. Contamos con logística
            propia para entregar e instalar en San José, Alajuela, Cartago,
        ...
        >
          ...
          >
            Desde el GAM hasta las costas
          </h3>
          <p style={{ color: "#a0c0b0" }}>
            Consulte por su zona. Ofrecemos visitas técnicas de evaluación en
            todo el territorio nacional (visitas gratuitas dentro de la GAM).
          </p>
        </div>
      </div>
    </div>
      ...
      <section id="proyectos" style={{ backgroundColor: "#f9fbf9" }}>
        <div className="container">
          ...
          >
            ...
            <p style={{ maxWidth: "600px", margin: "0 auto" }}>
              Resultados reales: transformaciones de "Antes y Después" que
              inspiran y reflejan nuestro profesionalismo.
            </p>
            <div className="project-stats">
              {siteData.stats.map((stat, index) => (
                <div className="project-stat-card" key={index}>
                  <h3>{stat.number}</h3>
            ...
            <div className="project-filter">
              ...
              <button
                className={projectFilter === "mantenimiento" ? "active" : ""}
                onClick={() => setProjectFilter("mantenimiento")}
              >
                🛠️ Mantenimiento
              </button>
            </div>
          ...
          >
            ...
            <div className="reveal">
              ...
              <p style={{ marginBottom: "40px", fontSize: "1.1rem" }}>
                Nuestro equipo técnico le contactará para asesorarle sobre el
                mejor zacate para su terreno.
              </p>
              ...
              >
                <MessageCircle size={28} style={{ marginRight: "15px" }} />{" "}
                Hablar por WhatsApp
              </a>
            </div>
        ...
        <div className="container">
          ...
          >
            <div style={{ gridColumn: "span 2" }}>
              ...
              >
                Transformamos espacios exteriores en experiencias naturales de
                alta gama. Especialistas en zacate y paisajismo profesional en
                Costa Rica.
              </p>
            ...
            <div>
              ...
              >
                <MapPin size={18} /> {siteData.location}
              </p>
              <p
                style={{
                  display: "flex",
              ...
              >
                <Map size={18} /> Cobertura Nacional
              </p>
            </div>
          </div>
          <div
          ...
          >
            © {new Date().getFullYear()} R&T Diseño Verde. Todos los derechos
            reservados.
          </div>
        </div>
      </footer>
